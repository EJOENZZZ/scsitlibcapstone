    ...
    <div className="flex min-h-screen font-sans">
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-blue-700 via-blue-800 to-slate-900 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-4xl font-bold text-white leading-tight mb-4">Your gateway to<br />knowledge starts here.</h2>
          <p className="text-blue-200 text-sm leading-relaxed">Access thousands of books, manage your borrowing history, and stay on top of your reading — all in one place.</p>
